...
<body>
	<!-- 数据显示 -->
	<table id="dg" title="用户管理" class="easyui-datagrid"  fitColumns="true" pagination="true" rownumbers="true" url="${pageContext.request.contextPath}/system/powerRoleList.do" fit="true" toolbar="#tb">
		<thead>
			<tr>
				<th field="cb" checkbox="true" align="center"></th>
				<th field="roleId" width="auto" align="center">角色ID</th>
				<th field="roleName" width="auto" align="center">角色名</th>
			</tr>
		</thead>
	</table>
	<!-- 工具栏 -->
