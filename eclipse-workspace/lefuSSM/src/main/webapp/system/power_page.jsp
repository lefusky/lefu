...
<body>
	<!-- 数据显示 -->
	<table id="dg" title="用户管理" class="easyui-datagrid"  fitColumns="true" pagination="true" rownumbers="true" url="${pageContext.request.contextPath}/system/powerPageList.do" fit="true" toolbar="#tb">
		<thead>
			<tr>
				<th field="cb" checkbox="true" align="center"></th>
				<th field="pageId" width="auto" align="center">页面元素ID</th>
				<th field="pageCode" width="auto" align="center">页面元素编码</th>
			</tr>
		</thead>
	</table>
	<!-- 工具栏 -->
