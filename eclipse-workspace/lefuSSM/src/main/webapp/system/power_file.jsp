...
<body>
	<!-- 数据显示 -->
	<table id="dg" title="用户管理" class="easyui-datagrid"  fitColumns="true" pagination="true" rownumbers="true" url="${pageContext.request.contextPath}/system/powerFileList.do" fit="true" toolbar="#tb">
		<thead>
			<tr>
				<th field="cb" checkbox="true" align="center"></th>
				<th field="fileId" width="auto" align="center">文件ID</th>
				<th field="fileName" width="auto" align="center">文件名</th>
				<th field="fileUrl" width="auto" align="center">文件路径</th>
			</tr>
		</thead>
	</table>
	<!-- 工具栏 -->
