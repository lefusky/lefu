...
<body>
	<!-- 数据显示 -->
	<table id="dg" title="用户管理" class="easyui-datagrid"  fitColumns="true" pagination="true" rownumbers="true" url="${pageContext.request.contextPath}/system/powerMenuList.do" fit="true" toolbar="#tb">
		<thead>
			<tr>
				<th field="cb" checkbox="true" align="center"></th>
				<th field="menuId" width="auto" align="center">菜单ID</th>
				<th field="menuName" width="auto" align="center">菜单名称</th>
				<th field="menuUrl" width="auto" align="center">菜单URL</th>
				<th field="menuPid" width="auto" align="center">父菜单ID</th>
			</tr>
		</thead>
	</table>
	<!-- 工具栏 -->
