...
<body>
	<!-- 数据显示 -->
	<table id="dg" title="用户管理" class="easyui-datagrid"  fitColumns="true" pagination="true" rownumbers="true" url="${pageContext.request.contextPath}/system/powerRightList.do" fit="true" toolbar="#tb">
		<thead>
			<tr>
				<th field="cb" checkbox="true" align="center"></th>
				<th field="rightId" width="auto" align="center">权限ID</th>
				<th field="rightType" width="auto" align="center">权限类型</th>
			</tr>
		</thead>
	</table>
	<!-- 工具栏 -->
