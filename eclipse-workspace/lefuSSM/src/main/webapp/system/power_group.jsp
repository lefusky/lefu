...
<body>
	<!-- 数据显示 -->
	<table id="dg" title="用户管理" class="easyui-datagrid"  fitColumns="true" pagination="true" rownumbers="true" url="${pageContext.request.contextPath}/system/powerGroupList.do" fit="true" toolbar="#tb">
		<thead>
			<tr>
				<th field="cb" checkbox="true" align="center"></th>
				<th field="groupId" width="auto" align="center">用户组ID</th>
				<th field="groupName" width="auto" align="center">用户组名称</th>
				<th field="groupPid" width="auto" align="center">父用户组名称</th>
			</tr>
		</thead>
	</table>
	<!-- 工具栏 -->
