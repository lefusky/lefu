...
<body>
	<!-- 数据显示 -->
	<table id="dg" title="用户管理" class="easyui-datagrid"  fitColumns="true" pagination="true" rownumbers="true" url="${pageContext.request.contextPath}/system/UserList.do" fit="true" toolbar="#tb">
		<thead>
			<tr>
				<th field="cb" checkbox="true" align="center"></th>
				<th field="userId" width="50" align="center">用户编号</th>
				<th field="userName" width="50" align="center">用户编号</th>
				<th field="userId" width="50" align="center">用户编号</th>
				<th field="userLogId" width="100" align="center">登录账号</th>
				<th field="userNick" width="100" align="center">用户昵称</th>
				<th field="roleId" width="100" align="center" formatter="formatRole">用户角色</th>
				<th field="departmentName" width="100" align="center">所属部门</th>
				<th field="addTime" width="100" align="center">添加时间</th>
