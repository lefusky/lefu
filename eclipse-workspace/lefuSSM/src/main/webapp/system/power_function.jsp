...
<body>
	<!-- 数据显示 -->
	<table id="dg" title="用户管理" class="easyui-datagrid"  fitColumns="true" pagination="true" rownumbers="true" url="${pageContext.request.contextPath}/system/powerFunctionList.do" fit="true" toolbar="#tb">
		<thead>
			<tr>
				<th field="cb" checkbox="true" align="center"></th>
				<th field="functionId" width="auto" align="center">操作ID</th>
				<th field="functionName" width="auto" align="center">操作名称</th>
				<th field="functionCode" width="auto" align="center">操作编码</th>
				<th field="functionUrl" width="auto" align="center">拦截URL前缀</th>
				<th field="functionPid" width="auto" align="center">父操作ID</th>
			</tr>
		</thead>
	</table>
	<!-- 工具栏 -->
